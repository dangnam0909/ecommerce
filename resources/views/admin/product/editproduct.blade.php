...
@section('title', 'Edit product | NL Fashtion')
@section('content')
						...
						<form method="POST" enctype="multipart/form-data" action="{{route('edit-product',$product->id)}}">
							...
							<div class="row" style="margin-bottom:40px">
								<div class="col-xs-8">
									...
									<div class="form-group" >
										<label>Price(VNĐ)<span style="color: red;">*</span></label>
									...
									<div class="form-group" >
										...
										<select name="status" class="form-control">
											<option value="1" @if($product->status == 1) selected @endif >Show</option>
							...
							<a href="{{route('product-admin')}}" class="btn btn-danger">Cancel</a>
						</form>
