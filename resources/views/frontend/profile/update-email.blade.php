	                    ...
	                    <div class="col-md-6">
	                        <div class="profile-head">
	                            ...
	                            <ul class="nav nav-tabs" id="myTab" role="tablist">
	                                <li class="nav-item">
	                                    <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">new email</a>
	                                </li>
	                ...
	                <div class="row">
	                    <div class="col-md-4">
	                        <div class="profile-work">
	                            ...
	                            <a href="{{route('view-update-password-user', Auth::user()->id)}}">Change pasword</a><br/>
